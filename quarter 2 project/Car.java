public class Car implements Runnable{
    ...
    public Car(int row, int col, int size, MyHashTable<Location,GridObject> map, Screen sc){
        this.row = row;
        this.col = col;
        this.size = size;
        this.map = map;
    ...
    public boolean canMoveLeft(){
        ...
        if(gridBucket.get(0).getName().equals("road") || gridBucket.get(0).getName().equals("road2")){
            return true;
        }
        return false;
    }
